; Listing generated by Microsoft (R) Optimizing Compiler Version 19.25.28612.0 
	...
	TITLE	C:\新书示例\C14_float\c_float_add\c_float_add.c
	.686P
	.XMM
	include listing.inc
	.model	flat
...
__8099EB0B_c_float_add@c DB 01H
msvcjmc	ENDS
...
; File C:\新书示例\C14_float\c_float_add\c_float_add.c
;	COMDAT _main
_TEXT	SEGMENT
_z$ = -32						; size = 4
_y$ = -20						; size = 4
...
; 4    : {
	...
	rep stosd
	mov	ecx, OFFSET __8099EB0B_c_float_add@c
